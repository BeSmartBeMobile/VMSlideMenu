...
//  Pods
//
//  Created by jmlucena on 26/5/17.
//
//
...
class GradientView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        guard let gradient = CGGradient.init(colorSpace: colorSpace, colorComponents: colorComponents, locations: locations, count: 2) else { return }
