...
@objc open class VMSlideMenuViewController: UIViewController {
    ...
    lazy var sectionsCollectionView: UICollectionView = {
        ...
        collectionView.register(SectionCollectionViewCell.self,
                                forCellWithReuseIdentifier: SectionCollectionViewCell.identifier)
...
extension VMSlideMenuViewController {
    ...
    func configureView() {
        ...
        // Constraints
        let views = ["tabsCollectionView": tabsCollectionView,
                     "sectionsCollectionView": sectionsCollectionView]

        let metrics = ["margin": 10,
                       "menuHeight": height]

        view.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|[tabsCollectionView]|",
                                                           options: [],
                                                           metrics: metrics,
                                                           views: views))

        view.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|[sectionsCollectionView]|",
                                                           options: [],
                                                           metrics: metrics,
                                                           views: views))

        view.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|[tabsCollectionView(==menuHeight)][sectionsCollectionView]|",
                                                           options: [],
                                                           metrics: metrics,
                                                           views: views))
    }
...
extension VMSlideMenuViewController: UICollectionViewDelegate {
    ...
    public func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        if collectionView == tabsCollectionView {
            ...
            guard let selectedTabIndexPath = tabsCollectionView.indexPathsForSelectedItems?.first else {
                return
            }

            sectionsCollectionView.scrollToItem(at: selectedTabIndexPath,
                                                at: .left,
                                                animated: true)
...
extension VMSlideMenuViewController: UICollectionViewDataSource {
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if collectionView == tabsCollectionView {
            guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: TabCollectionViewCell.identifier,
                                                                for: indexPath) as? TabCollectionViewCell else {
            ...
            guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: SectionCollectionViewCell.identifier,
...
extension VMSlideMenuViewController: UIScrollViewDelegate {
    ...
    public func scrollViewDidEndDecelerating(_ scrollView: UIScrollView) {
        ...
        guard scrollView == sectionsCollectionView else {
            return
        }
        ...
        tabsCollectionView.selectItem(at: indexPath,
                                      animated: true,
